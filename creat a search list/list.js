...
//     const pTags = keyList.querySelectorAll('p');
  
//     pTags.forEach((pTag) => {
//       const text = pTag.innerText.toUpperCase();
  
//       if (text.includes(filter)) {
//         pTag.style.display = 'block'; // Eşleşme varsa görünür yap
//       } else {
//         pTag.style.display = 'none'; // Diğerlerini gizle
//       }
//     });
//   }